...
from careapp.views import ChildListView, ChildCreateView, ChildUpdateView, \
    ...
    DiaperingUpdateView, TerryCreateView
...
urlpatterns = [
    ...
    url(r'^dailyreport/update/(?P<id>\d+)/$',
        DailyReportUpdateView.as_view(),
        name='dailyreport-update'),

    url(r'^$', TemplateView.as_view(
        template_name='careapp/index.html'),
        name='index',),
    # url(r'^$', index, name='index'),
    url(r'^calander$', TemplateView.as_view(
        template_name='careapp/calander.html'),
        name='calander',),

    url(r'^dailyreport/diapering/create/(?P<id>\d+)/$',
        DiaperingCreateView.as_view(),
        name='diapering-create',),
    url(r'^dailyreport/diapering/update/(?P<id>\d+)/$',
        DiaperingUpdateView.as_view(),
        name='diapering-update',),
    # url(r'^diapering/new$',
    #     DiaperingCreateView.as_view(),
    #     name='diapering',),
    url(r'^dailyreport/sleeping/new/(?P<id>\d+)/$',
        SleepingCreateView.as_view(),
        name='sleeping',),
    url(r'^dailyreport/eating/new/(?P<id>\d+)/$',
        EatingCreateView.as_view(),
        name='eating',),
